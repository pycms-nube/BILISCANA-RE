...
static PyCodeObject *codeobj_29266fe3b9668170c14a8f676d881f11;

static void createModuleCodeObjects(void) {
    module_filename_obj = mod_consts[1]; CHECK_OBJECT(module_filename_obj);
    codeobj_29266fe3b9668170c14a8f676d881f11 = MAKE_CODEOBJECT(module_filename_obj, 1, CO_NOFREE, mod_consts[57], NULL, NULL, 0, 0, 0);
}
...
// Mark the execution in the "__spec__" value.
    ...
    struct Nuitka_FrameObject *frame_29266fe3b9668170c14a8f676d881f11;
    ...
    // Frame without reuse.
    frame_29266fe3b9668170c14a8f676d881f11 = MAKE_MODULE_FRAME(codeobj_29266fe3b9668170c14a8f676d881f11, module_chardet$escsm);

    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStack(frame_29266fe3b9668170c14a8f676d881f11);
    assert(Py_REFCNT(frame_29266fe3b9668170c14a8f676d881f11) == 2);
    ...
    }
    {
        ...
        frame_29266fe3b9668170c14a8f676d881f11->m_frame.f_lineno = 28;
...
#if 0
    RESTORE_FRAME_EXCEPTION(frame_29266fe3b9668170c14a8f676d881f11);
#endif
    popFrameStack();

    assertFrameObject(frame_29266fe3b9668170c14a8f676d881f11);
    ...
    if (exception_tb == NULL) {
        exception_tb = MAKE_TRACEBACK(frame_29266fe3b9668170c14a8f676d881f11, exception_lineno);
    } else if (exception_tb->tb_frame != &frame_29266fe3b9668170c14a8f676d881f11->m_frame) {
        exception_tb = ADD_TRACEBACK(exception_tb, frame_29266fe3b9668170c14a8f676d881f11, exception_lineno);
    }
