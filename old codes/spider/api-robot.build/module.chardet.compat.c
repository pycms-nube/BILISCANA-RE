...
static PyCodeObject *codeobj_c7131e625670e9ecaa55652f7ebf35b1;

static void createModuleCodeObjects(void) {
    module_filename_obj = mod_consts[1]; CHECK_OBJECT(module_filename_obj);
    codeobj_c7131e625670e9ecaa55652f7ebf35b1 = MAKE_CODEOBJECT(module_filename_obj, 1, CO_NOFREE, mod_consts[16], NULL, NULL, 0, 0, 0);
}
...
// Mark the execution in the "__spec__" value.
    ...
    struct Nuitka_FrameObject *frame_c7131e625670e9ecaa55652f7ebf35b1;
    ...
    // Frame without reuse.
    frame_c7131e625670e9ecaa55652f7ebf35b1 = MAKE_MODULE_FRAME(codeobj_c7131e625670e9ecaa55652f7ebf35b1, module_chardet$compat);

    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStack(frame_c7131e625670e9ecaa55652f7ebf35b1);
    assert(Py_REFCNT(frame_c7131e625670e9ecaa55652f7ebf35b1) == 2);
    ...
    }
    {
        ...
        frame_c7131e625670e9ecaa55652f7ebf35b1->m_frame.f_lineno = 22;
...
#if 0
    RESTORE_FRAME_EXCEPTION(frame_c7131e625670e9ecaa55652f7ebf35b1);
#endif
    popFrameStack();

    assertFrameObject(frame_c7131e625670e9ecaa55652f7ebf35b1);
    ...
    if (exception_tb == NULL) {
        exception_tb = MAKE_TRACEBACK(frame_c7131e625670e9ecaa55652f7ebf35b1, exception_lineno);
    } else if (exception_tb->tb_frame != &frame_c7131e625670e9ecaa55652f7ebf35b1->m_frame) {
        exception_tb = ADD_TRACEBACK(exception_tb, frame_c7131e625670e9ecaa55652f7ebf35b1, exception_lineno);
    }
